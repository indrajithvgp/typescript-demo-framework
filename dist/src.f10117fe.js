...
var Eventing = function () {
  function Eventing() {
    ...
    this.on = function (eventName, callback) {
      ...
      _this.events[eventName] = handlers; // this.events[eventName] = [...this.events[eventName], callback]
    };
...
var Sync = function () {
  function Sync(rootUrl) {
    ...
    this.fetch = function (id) {
      return axios_1.default.get("http://localhost:3000/users/" + id);
    };
    ...
    this.save = function (data) {
      ...
      if (id) {
        return axios_1.default.put(_this.rootUrl + "/" + id, data); // .then((response: AxiosResponse):void => {
...
//         })
// }
},{"./Eventing":"src/models/Eventing.ts","./Sync":"src/models/Sync.ts","./Attributes":"src/models/Attributes.ts","./Model":"src/models/Model.ts"}],"src/views/UserForm.ts":[function(require,module,exports) {
"use strict";
...
var User_1 = require("./models/User"); // const user = User.buildUser({id:1})
// user.on('change',()=>{
//     console.log('changed')
// })
// user.fetch()
